    ...
    <div className={classes.Description}>
      ...
      <div className={classes.Description_content}>
        <p>
          ...
          <mark>‘1Pixel(1PX)’</mark> 팀은 2023년 상반기 학기 중 프로젝트를 통해
          타이포그래피 작업을 기반으로 한 영화 포스터를 제작하고 이를 소개하는
          잡지를 제작하였습니다. 이를 발전시켜 이어지는 여름 방학에 인터렉티브
          웹사이트 사이트를 구성하는 프로젝트를 진행하였고, 최종 성과를
          ‘성장무한육면각체' 전시에 보여주게 되었습니다.
          <br />
          ...
          각자가 좋아하는 영화를 고르고 이를 표현하는 맥락에서 보여지는 1PX
          팀원들의 취향이 어떤 방식으로 재생산 될 수 있는지를 다양한 매체 위에서
          실험해 볼 수 있었던 이번 프로젝트는 팀원들의 개성있는 작업물들을
          모아볼 수 있도록 영화 필름 형태에 나열된 프리뷰 페이지에서 시작하여,
          전시회장에 마련된 화면을 통해 직접 구현된 인터렉션을 체험해 볼 수
          있습니다. 관람자와 작품의 상호작용을 통해 관람자는 다른 세계에의
          몰입을 경험할 수 있고 경험은 그를 새롭게 구성할 것입니다. 우리의
          전시가 계속하여 새로 태어나는 메시지의 파장을 만들기를 기대합니다.
        </p>
      </div>
    </div>
  );
